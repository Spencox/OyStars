...
console.log(typeof oysterBarShowEl)
console.log(oysterBarShowEl)

// for (let i = 0; i < oysterBarShowEl.length; i++) {
//     // Access each element using the numeric properties
//     const element = oysterBarShowEl[i];
//     console.log(element);
//   }

//   for (let i = 0; i < oysterRatingShowEl.length; i++) {
//     // Access each element using the numeric properties
//     const element = oysterRatingShowEl[i];
//     oysterRatingShowEl[i].textContent = "Five Stars";
//     console.log(element);
//   }
...
// const searchUrl = `${CORSanywhere}https://api.yelp.com/v3/businesses/search?location=${city}&term=${term}&limit=20`;
...
function display5Recs(oysterBarsArr, names, ratings) {
    ...
    ratings.each(function(index) {
        ...
        console.log(oysterRatingEl.text())
    });
}
