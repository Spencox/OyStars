...
const sampleResults = {
    "businesses": [
        ...
        {
            "id": "RloVMlIr8kP8Sn609loBTg",
            "alias": "30-90-nola-new-orleans",
            "name": "30/90 NOLA",
            "image_url": "https://s3-media2.fl.yelpcdn.com/bphoto/iatFtz78t7-PNh0UZDFxXw/o.jpg",
            "is_closed": false,
            "url": "https://www.yelp.com/biz/30-90-nola-new-orleans?adjust_creative=GvILGFxL2OCuepCm0neQ1A&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=GvILGFxL2OCuepCm0neQ1A",
            "review_count": 347,
            "categories": [
                {
                    "alias": "bars",
            ...
            "rating": 4.0,
            "coordinates": {
                "latitude": 29.963054527067765,
                "longitude": -90.05798834429156
            },
            "transactions": [],
            "price": "$$",
            "location": {
                "address1": "520 Frenchmen St",
                "address2": "",
                "address3": "",
                "city": "New Orleans",
                "zip_code": "70116",
            ...
            "phone": "+15049492576",
            "display_phone": "(504) 949-2576",
            "distance": 2601.9085514557614
        },
        {
            "id": "L7_Nw3v0ByYzxLqQ5gmYKQ",
            "alias": "little-bar-on-gravier-new-orleans",
            "name": "Little Bar On Gravier",
            "image_url": "https://s3-media3.fl.yelpcdn.com/bphoto/KTxmGCAa2ueGtnMmI-qS2g/o.jpg",
            "is_closed": false,
            "url": "https://www.yelp.com/biz/little-bar-on-gravier-new-orleans?adjust_creative=GvILGFxL2OCuepCm0neQ1A&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=GvILGFxL2OCuepCm0neQ1A",
            "review_count": 45,
            "categories": [
                {
                    "alias": "bars",
            ...
            "phone": "+15043336665",
            "display_phone": "(504) 333-6665",
            "distance": 1635.6560535691438
        }
    ],
    "total": 658,
    "region": {
...
console.log(meterToMiles(16000))

// API pulls
const term = parameterize("Oyster Bar");
const radius = parameterize(16000);
const city = parameterize("New Orleans")
...
const searchUrl = `https://api.yelp.com/v3/businesses/search?location=${city}&term=${term}&sort_by=rating&limit=5`
